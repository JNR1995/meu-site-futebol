...
st.markdown("""
    ...
    div.stButton > button { background-color: #1E1E1E; color: white; border-radius: 66px; border: 2px solid #333; height: 3.5em; width: 100%; font-family: 'Montserrat', sans-serif; font-weight: bold; transition: 0.3s; }
