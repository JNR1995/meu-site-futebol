                    ...
                    if data_h and data_a:
                        ...
                        if data_h and data_a:
                            ...
                            with col_exp1:
                                ...
                                st.markdown(f"""
                                    <div style='font-size: 13px; color: #bbb; margin-top: -1px; margin-bottom: -2px;'><strong>Expc. Gols Jogo (Média)</strong></div>
                            ...
                            with col_exp2:
                                ...
                                st.markdown(f"""
                                    <div style='font-size: 13px; color: #bbb; margin-top: -1px; margin-bottom: -2px;'><strong>Expc. Gols HT (MD)</strong></div>
