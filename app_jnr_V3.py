...
st.markdown("""
    ...
    .liga-header { text-align: center; background-color: #1E1E1E; color: #FFFFFF; padding: 4px; font-weight: bold; font-size: 22px; border-radius: 8px; margin-top: 50px; border: 1px solid #333; margin-bottom: -12.5px !important; }
